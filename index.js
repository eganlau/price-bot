...
async function checkPair(args) {
  ...
  console.table([{
    ...
    'Timestamp': moment().tz('Asia/Hong_Kong').format(),
  }])
}
...
async function monitorPrice() {
  ...
  try {
    ...
    then((averageGasPrice) => {
        console.log("Average gas price:",web3.utils.fromWei(averageGasPrice, 'ETHER')," ETH or ",
        web3.utils.fromWei(averageGasPrice, 'gwei')," gwei");
